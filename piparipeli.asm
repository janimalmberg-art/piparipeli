;==========================================================
; C64 PIPARI LEIPOMO - ACME ASSEMBLER (KORJATTU)
; Liikutus: W,A,S,D
...
RollingMiniGameLogic:
    ...
    ; Tarkista painoiko oikeaa numeroa
    sec
...
;==========================================================
InitSprites:
    ; KORJAUS 1: Kytketään vain spritet 0 ja 1 päälle (binary 00000011)
    ; Alkuperäinen lda #$ff kytki kaikki 8 spriteä, joista 6 näytti roskaa.
    lda #$03
    sta VIC_SPR_ENA 
...
UpdatePlayerSprite:
    ; X-koordinaatti
    lda PLAYER_X
    ; KORJAUS 2: Poistettu 'asl' ja 'lsr', jotka estivät liikkumisen
    ; yli koordinaatin 128 (oikeaan reunaan).
    sta VIC_SPR_X
